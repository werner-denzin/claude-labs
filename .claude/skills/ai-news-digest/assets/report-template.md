...
| Summary | |
| --- | --- |
| **Highlights** | {{N}} · 🔴 {{N_HIGH}} high · 🟠 {{N_MEDIUM}} medium · 🔵 {{N_LOW}} low |
| **Categories** | {{LENS_MIX -- got/target per lens. Do not count by hand: python3 scripts/build_card.py --in digest.json --lens-mix}} |
